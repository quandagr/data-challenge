...
// 1. Get names of all active students
let summaryStrings = students
    .map(student => `${student.name} is ${student.age} years old and enrolled in ${student.courses.length} courses.`);
